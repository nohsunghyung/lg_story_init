...
<html lang="ko">
  ...
  <head>
    ...
    <meta property="og:title" content="[콘텐츠 제목] | LG 전자" />
    <!-- [콘텐츠 제목]에 전달받은 제목을 입력해주세요. -->
    <meta property="og:description" content="[디스크립션 텍스트]" />
    <!-- [디스크립션 텍스트]에 전달받은 텍스트를 입력해주세요. -->
    <meta property="og:url" content="https://www.lge.co.kr/story/[콘텐츠 업로드 메뉴 폴더명]/[콘텐츠 고유 url명]" />
    ...
    <!-- UnivEBiz css, script -->
    <link rel="stylesheet" href="/kr/story/[콘텐츠 업로드 메뉴 폴더명]/css/[콘텐츠 고유 url명].css" type="text/css" />
    <!-- [콘텐츠 업로드 메뉴 폴더명], [콘텐츠 고유 url명] 을 변경하세요. -->
    <script type="text/javascript" src="/kr/story/[콘텐츠 업로드 메뉴 폴더명]/js/libs/jquery-2.2.4.min.js"></script>
    <!-- [콘텐츠 업로드 메뉴 폴더명] 에 전달받은 경로를 입력하세요.. -->
    <script type="text/javascript" src="/kr/story/[콘텐츠 업로드 메뉴 폴더명]/js/[콘텐츠 고유 url명].js"></script>
    <!-- [콘텐츠 업로드 메뉴 폴더명], [콘텐츠 고유 url명] 을 변경하세요. -->
  ...
  <body>
    ...
    <div class="wrap">
      ...
      <meta itemprop="name" content="[콘텐츠 제목] | LG 전자" />
      <!-- [콘텐츠 제목]에 전달받은 제목을 입력해주세요. -->
      <meta itemprop="description" content="[디스크립션 텍스트]" />
      <!-- [디스크립션 텍스트]에 전달받은 텍스트를 입력해주세요. -->
      <meta itemprop="url" content="https://www.lge.co.kr/story/[콘텐츠 업로드 메뉴 폴더명]/[콘텐츠 고유 url명]" />
      <!-- [콘텐츠 업로드 메뉴 폴더명], [콘텐츠 고유 url] 에 전달받은 경로를 입력하세요. -->
